    ...
    <Popup title={title} setShow={setShow}>
      <div className="border border-gray-600 hover:border-cyan-500   ">
        <div className="p-9 pb-3 ">
          <p className=" bg-gradient-to-br from-gray-400 via-gray-500 to-gray-700 text-transparent inline-block bg-clip-text font-semibold text-md   ">
            {description}
          </p>
        </div>
        <div className=" flex align-middle items-center text-center justify-end px-9 py-3 border border-l-0 border-r-0  border-gray-500 ">
          <button className="shadow-sm   bg-gradient-to-b from-cyan-300 via-cyan-500  to-blue-800 gap-2 text-transparent inline-block bg-clip-text font-bold text-sm   ">
